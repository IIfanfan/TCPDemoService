...
namespace RP.ScoutRobot.Communication
{
    ...
    public struct SocketDateStruct
    {
        ...
        public short Distance;//距离高位
        public short XAxisAcceleration;//X轴加速度高位
        public short YAxisAcceleration;//Y轴加速度高位
        public short ZAxisAcceleration;//Z轴加速度高位
        public short PitchAngle;//俯仰角高位
        public short RollAngle;//横滚角高位
        public short CourseAngle;//航向角高位
    }
